...
class FixBlankLines(BaseFix):
    ...
    def transform(self, node, results):
        ...
        if newline_node.type in [token.INDENT, token.NEWLINE]:
            # If the newline_node is an indent or newline, we don't need to worry about fixing indentation
            # since it is not part of the prefix. Dedents do have it as part of the prefix.
        ...
        new_prefix = self.trim_comments(curr_node_indentation, newline_node.prefix, min_lines_between_defs, max_lines_between_defs)
    ...
    def trim_comments(self, curr_node_indentation, previous_whitespace, min_lines_between_defs, max_lines_between_defs):
